...
public abstract class SimpleGraph {
    ...
    /***
     ...
     the Prim algorithm is a way that we can find minimum spanning tree of a graph.
     ***/
    ...
    /**
     * @param start
     * DFS algorithm is a traversal that we choose a node as root, and then we print All its adjacent.
    ...
    /**
     * Dijkstra Algorithms
     * In this algorithm we try to find the shortest path from one vertex to the other vertices.
